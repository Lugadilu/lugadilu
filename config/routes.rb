Rails.application.routes.draw do
  ...
  get 'hydrology', to: 'home#hydrology', as: "hydrology"
  ...
  namespace :homemain do
    # root "blog#index", as: "darkest"
    # root "blogg#index", as: "blogg2"
    get "darkest", to: "blog#index", as: "darkest"
    get "blogg2", to: "blogg#index", as: "blogg2"
    
  end

  namespace :dashboard do
    # get '/dashboard', to: 'dashboard#index', as: 'index'
    resources :projects, param: :slug
